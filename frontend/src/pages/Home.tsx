  ...
  return (
    <main className="flex-grow h-screen p-8 overflow-auto bg-gray-900 text-white">
      ...
      <div className="mt-8 space-x-4">
        <button onClick={addExercise} className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full transition duration-300 ease-in-out">
          Agregar ejercicio
        </button>
        <button onClick={addMeal} className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-full transition duration-300 ease-in-out">
          Agregar comida
        </button>
      </div>
